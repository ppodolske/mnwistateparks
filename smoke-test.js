...
const explore=check('/explore',[...nav,'href="/find"','Find a park for my trip','href="/collections"','Browse collections','class="button blue" href="/collections"']);
...
if(VERSION!=='1.5.2')throw new Error(`Unexpected version ${VERSION}`);
...
console.log('Smoke tests passed: v1.5.2 visible collections CTA, curated collections, guided finder, trip planning, 116/116 static map.');
