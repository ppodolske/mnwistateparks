const fs=require('fs');
const {VERSION,parks,renderPath,clientJS,loadCoords,COLLECTIONS,practical}=require('./site.js');
...
if(VERSION!=='1.7.0')throw new Error(`Unexpected version ${VERSION}`);
...
console.log(`Smoke tests passed: v1.7.0 single-runtime consolidation, parity, finder, collections, trips, client JS, and 116/116 static map.`);
