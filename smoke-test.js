...
check('/explore',[...nav,'href="/find"','Find a park for my trip','href="/collections"','Browse collections']);
...
if(VERSION!=='1.5.0')throw new Error(`Unexpected version ${VERSION}`);
...
console.log('Smoke tests passed: v1.5.0 curated collections, guided finder, richer trip planning, 116/116 static map, canonical navigation, save/compare.');
