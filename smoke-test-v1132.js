...
assert(VERSION==='1.13.3',`Unexpected version ${VERSION}`);
...
console.log('Smoke tests passed: v1.13.3 single-page overview pagination, assigned-day booklet flow, continuation pages, source review text 116/116, 116/116 park references, and 116/116 map.');
