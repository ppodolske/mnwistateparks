...
for(const token of ['tripRouteOverview','dayPlanHelp','workspaceStops','itineraryModelPanel','Canonical working order','Trip details','Day-by-day itinerary','window.TripWorkspaceCleanup'])assert(tripWorkspaceCleanupJS.includes(token),`Workspace cleanup missing ${token}`);
