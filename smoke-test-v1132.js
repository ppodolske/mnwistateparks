...
for(const token of ['tripRouteOverview','dayPlanHelp','workspaceStops','itineraryModelPanel','Trip details','Day-by-day itinerary','window.TripWorkspaceCleanup'])assert(tripWorkspaceCleanupJS.includes(token),`Workspace cleanup missing ${token}`);
