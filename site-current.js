...
const parkDetails=require('./park-details.js');
...
function injectAll(html){
  const scripts='<script src="/trip-model.js" defer></script><script src="/planner-polish.js" defer></script><script src="/park-details.js" defer></script><script src="/park-addresses.js" defer></script><script src="/trip-details.js" defer></script>';
...
module.exports={...site,VERSION,tripModelJS,plannerJS,tripDetailsJS,parkDetailsJS,parkAddressesJS,parkDetails,injectAll,createServer};
